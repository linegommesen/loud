...
function radio_show_player() {
    if (typeof jQuery == 'function') {
        jQuery('#show-player').fadeIn(1000);
    } else {
        document.getElementById('show-player').style.display = 'block';
    }
}
...
function radio_show_responsive() {
    ...
    if (typeof jQuery == 'function') {
        ...
        if (showcontent.width() < 500) {
            showcontent.addClass('narrow');
        } else {
            showcontent.removeClass('narrow');
        }

    } else {
        showcontent = document.getElementById('show-content');
        if (showcontent.offsetWidth < 500) {
            showcontent.classList.add('narrow');
        } else {
            showcontent.classList.remove('narrow');
        }
    }
    ...
    if (document.getElementById('show-content').className.indexOf('top-blocks') < 0) {
        ...
        if (info && desc) {
            ...
            if (about) {
                descheight = descheight - about.offsetHeight;
            }
            if (descheight < desc.style.minHeight) {
...
function radio_show_desc(moreless) {
    if (moreless == 'more') {
        if (typeof jQuery == 'function') {
            jQuery('#show-description').addClass('expanded');
        } else {
            document.getElementById('show-description').classList.add('expanded');
        }
        document.getElementById('show-more-overlay').style.display = 'none';
    ...
    if (moreless == 'less') {
        if (typeof jQuery == 'function') {
            jQuery('.show-description').removeClass('expanded');
        } else {
            document.getElementById('show-description').classList.remove('expanded');
        }
        document.getElementById('show-more-overlay').style.display = 'block';
...
document.querySelector(".master-schedule-tabs-day-name").addEventListener("click", clicked);
