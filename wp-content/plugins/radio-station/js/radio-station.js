...
var radio_resize_debounce = (function () {
    ...
    return function (callback, ms, uniqueId) {
        if (!uniqueId) {
            uniqueId = "nonuniqueid";
        }
        if (debounce_timers[uniqueId]) {
            clearTimeout(debounce_timers[uniqueId]);
        }
...
if (typeof jQuery == 'function') {
    jQuery(document).ready(function () {
        if (jQuery('.radio-user-timezone').length) {
            ...
            if ((useroffset * 60) == radio.timezone.offset) {
                return;
            }
            if (typeof jstz == 'function') {
